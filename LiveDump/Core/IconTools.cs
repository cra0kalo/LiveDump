...
// (updated 2014/11/13)
// updated by Cra0 (fixed wrongly defined data in structs, added speed improvements)
...
public enum ShellIconSize : uint
{
    ...
    //SHGFI_USEFILEATTRIBUTES assumes the file exists
    //("Do not access the disk. Pretend that the file/directory exists, and that its file attributes are what I passed as the dwFileAttributes parameter.
    //  Do this regardless of whether it actually exists or not.")
    //More here: http://blogs.msdn.com/b/oldnewthing/archive/2004/06/01/145428.aspx

    /// <summary>
    /// Specifies a small (16x16) icon.
    /// </summary>
    SmallIcon = IconTools.SHGFI_ICON | IconTools.SHGFI_SMALLICON | IconTools.SHGFI_USEFILEATTRIBUTES,
    /// <summary>
    /// Specifies a large (32x32) icon.
    /// </summary>
    LargeIcon = IconTools.SHGFI_ICON | IconTools.SHGFI_LARGEICON | IconTools.SHGFI_USEFILEATTRIBUTES
}